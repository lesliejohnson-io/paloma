      ...
      <div style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        <div style={{ padding: '12px 22px 6px' }}>
          <div style={{
            ...
            fontFamily: SANS,
          }}>Belief we're working against</div>
          <div style={{
        ...
        <div style={{
          ...
          {['All', 'Courage acts', 'Belief shifts', 'Witnessed'].map((f, i) => (
            <div key={f} style={{
          ...
          {newEntryProgress > 0.01 && (
            <div style={{
              ...
              <div style={{
                ...
                borderRadius: 14,
                padding: 2,
                background: `linear-gradient(180deg, ${C.purple500}aa, transparent)`,
                opacity: Math.max(0, 1 - Math.max(0, (newEntryProgress - 0.7)) / 0.3),
              }}>
                <EntryCard
                  type={NEW_ENTRY.type}
                  body={NEW_ENTRY.body}
...
function PalomaScene() {
  ...
  const ENTRY_SLOT_START = 23.6;
  const ENTRY_SLOT_END = 25.2;
